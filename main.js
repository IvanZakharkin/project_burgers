...
(function () {
  var ingredients = $('.burgers__ingredients-info');
  ingredients.on("click", function (e) {
    $(this).parent().toggleClass('burgers__ingredients_active');
  });
  var closeIngridients = $(".burgers__close-btn").on("click", function (e) {
    e.preventDefault();
    console.log($(this));
  ...
  function moveSlide(slider, numSlide) {
    var sliderItems = slider.find(".burgers__item"),
  ...
  function moveToDirection(direction) {
    var container = $(".burgers__container"),
...
(function () {
  ...
  var closeBtn = modalOrder.querySelector('.modal-order__close');
  var modalOrderContent = modalOrder.querySelector('.modal-order__content');
...
(function () {
  ...
  burgerMenu.addEventListener("click", function (event) {
    ...
    if (burgerMenu.classList.contains("hamburger-menu_active")) {
      ...
      nav.style.top = '-9999px'; // document.body.removeAttribute('style');
    } else {
      burgerMenu.classList.add("hamburger-menu_active");
      modal.classList.add("modal_active");
      nav.style.top = '50%'; // document.body.style.overflow = "hidden";
    }
  });
...
(function () {
  function createDots() {
    $(".section").each(function () {
      ...
      var dot = $("<li>", {
        ...
        html: "<a href=\"#menu\" class=\"navigation__link\"  data-scroll-to = #".concat($this.attr("id"), "></a>")
      });
      $(".navigation__list").append(dot);
    });
  }
  ...
  var performTransition = function performTransition(sectionNum) {
  ...
  $("[data-scroll-to]").on("click", function (e) {
    ...
    var numSection = sections.filter("".concat(sectionName)).index();
  ...
  if (md.mobile()) {
    $(".burgers").swipe({
      swipe: function swipe(event, direction, distance, duration, fingerCount, fingerData) {
        var scrollTo = direction === "left" ? "next" : "prev";
...
(function () {
  ...
  function init() {
    ...
    var myPlacemark1 = new ymaps.Placemark([59.97, 30.30], {
      hintContent: 'адрес...',
    ...
    var myPlacemark2 = new ymaps.Placemark([59.94, 30.38], {
      hintContent: 'адрес...',
      balloonContent: 'Самые вкусные бургеры! Заходите по адресу: адрес...'
    }, {
      iconLayout: 'default#image',
    ...
    var myPlacemark3 = new ymaps.Placemark([59.91, 30.49], {
      hintContent: 'адрес...',
      balloonContent: 'Самые вкусные бургеры! Заходите по адресу: адрес...'
    }, {
      iconLayout: 'default#image',
    ...
    var myPlacemark4 = new ymaps.Placemark([59.88, 30.31], {
      hintContent: 'адрес...',
      balloonContent: 'Самые вкусные бургеры! Заходите по адресу: адрес...'
    }, {
      iconLayout: 'default#image',
...
(function () {
  var createModal = function createModal(template) {
...
(function () {
  ...
  var videoSlider = $(".video__playback-slider");
  var play = $(".video__duration-img");
  var playBig = $(".video__player-img");
  ...
  video.addEventListener("play", function (e) {
    ...
    interval = setInterval(function () {
      var completedSec = video.currentTime;
  ...
  $(".video__playback").on("click", function (e) {
    if (e.target === videoSlider.get(0)) return;
    var bar = $(e.currentTarget);
    var newButtonPosition = e.pageX - bar.offset().left;
    var duration = bar.width();
    var buttonPosPer = newButtonPosition / duration * 100;
    var newPlayerTimeSec = video.duration / 100 * buttonPosPer;
    videoSlider.css({
      left: "".concat(buttonPosPer, "%")
    });
...
(function () {
  ...
  btnDetail.on("click", function (e) {
    e.preventDefault();
    var authorReview = $(this).parent().find(".reviews__name").text();
    var detailTextReview = $(this).parent().find(".reviews__detail-text").text();
